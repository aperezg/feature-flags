...
##  ______         _                    ______ _
## |  ____|       | |                  |  ____| |
## | |__ ___  __ _| |_ _   _ _ __ ___  | |__  | | __ _  __ _ ___
## |  __/ _ \/ _` | __| | | | '__/ _ \ |  __| | |/ _` |/ _` / __|
## | | |  __/ (_| | |_| |_| | | |  __/ | |    | | (_| | (_| \__ \
## |_|  \___|\__,_|\__|\__,_|_|  \___| |_|    |_|\__,_|\__, |___/
##                                                      __/ |
##                                                     |___/
##
##   @author: Adrian Perez <me@adrianpg.com>
##   @description: Feature flags API written in GOlang.
##
##
...
build: ## Compile on your own architecture
	go build -o ${BUILD_DIR}/${APPLICATION_NAME} ${MAIN_FILE}
...
build-linux: ## Build the project to linux platforms
	CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ${BUILD_DIR}/${APPLICATION_NAME} ${MAIN_FILE}

docker-build: ## Build the binary into a docker container
	docker run --rm -it -v "${PWD}":/go/src/${PKG} -w /go/src/${PKG} golang:latest go build -o ${BUILD_DIR}/${APPLICATION_NAME} ${MAIN_FILE}